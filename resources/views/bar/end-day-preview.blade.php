...
<head>
  ...
  <title>Preview Print End Day Bar</title>
...
<body class="bg-gray-100 text-gray-900">
  <div class="no-print sticky top-0 z-20 border-b border-gray-200 bg-white/95 backdrop-blur">
    <div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
      <div>
        <p class="text-sm font-semibold text-gray-900">Preview Print Struk - End Day Bar</p>
        <p class="text-xs text-gray-500">Cek tampilan sebelum kirim reprint ke printer Bar.</p>
      </div>
      ...
      <div class="flex items-center gap-2">
        ...
        <button type="button"
                ...
                class="inline-flex items-center justify-center rounded-lg border border-purple-300 px-3 py-2 text-sm font-medium text-purple-700 hover:bg-purple-50">
          Save PDF
        </button>

        <form method="POST"
              action="{{ route('admin.bar.end-day.reprint', $history) }}">
          @csrf
          <button type="submit"
                  class="inline-flex items-center justify-center rounded-lg bg-purple-500 px-3 py-2 text-sm font-semibold text-white hover:bg-purple-600">
            Reprint Sekarang
          </button>
        </form>
      </div>
  ...
  <main class="preview-shell py-6 print:py-0">
    <div class="print-sheet">
      <header class="border-b border-dashed border-gray-300 pb-2 text-center">
        <h1 class="text-sm font-bold tracking-tight text-gray-900">END DAY BAR</h1>
      ...
      <p class="mt-3 border-t border-dashed border-gray-300 pt-2 text-center text-[10px] text-gray-500">--- END OF BAR REPORT ---</p>
    </div>
  </main>
</body>
