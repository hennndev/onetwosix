...
class GeneralSettingController extends Controller
{
    ...
    public function update(Request $request): RedirectResponse
    {
        $validated = $request->validate([
            ...
            'accurate_extra_charge_account_no' => ['nullable', 'string', 'max:50'],
            'accurate_food_sales_account_no' => ['nullable', 'string', 'max:50'],
            'accurate_beverage_sales_account_no' => ['nullable', 'string', 'max:50'],
            'accurate_cigarette_sales_account_no' => ['nullable', 'string', 'max:50'],
            'accurate_sales_discount_account_no' => ['nullable', 'string', 'max:50'],
            'accurate_breakage_account_no' => ['nullable', 'string', 'max:50'],
