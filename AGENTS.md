...
- **Membaca Knowledge Base**: Sebelum melakukan analisis arsitektur, refactoring, atau investigasi hubungan antar file, selalu gunakan `graphify-out/GRAPH_REPORT.md` untuk memahami Community Hubs, God Nodes, dan relasi dependencies.
